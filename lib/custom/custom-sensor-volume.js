...
SceneMode
	...
	var CustomSensorVolumeFS = require('./custom-sensor-volume-fs.glsl');
	var CustomSensorVolumeVS = require('./custom-sensor-volume-vs.glsl');
	var SensorVolume = require('../sensor-volume.glsl');
